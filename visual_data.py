...
class VisualData:
    def __init__(self, view):
        ...
        self.pos_marketing = self.mid_triangle_pos - Vec(0, self.sc.get[1] / 11)
        ...
        self.pos_invest_left = self.pos_invest_center - Vec(self.sc.get[0] / 9, 0)
        self.pos_invest_right = self.pos_invest_center + Vec(self.sc.get[0] / 9, 0)
