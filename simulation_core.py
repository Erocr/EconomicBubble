...
class InvestorNode(BaseNode):
    def __init__(self, bubble, observer, capital_node):
        super().__init__(bubble, observer, capital_node)
        self.max_value = 100
        ...
        self.newest_record = 0    1, val2, keepHistory=False):
